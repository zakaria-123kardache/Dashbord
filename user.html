        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="sidebarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="categorie.html">
              ...
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="tags.html">
              ...
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="cours.html">
              ...
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="validation.html">
